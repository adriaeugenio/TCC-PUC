...
v = ve.verificaPasta(p.pastaDados + '/Empresas Aéreas Estrangeiras Regulares')

pasta = p.pastaDados + '/Empresas Aéreas Estrangeiras Regulares/'
...
p = {'download.default_directory':p.caminhoPastaAlternativo + 'Dados\\Empresas Aéreas Estrangeiras Regulares'}
...
navegador.find_element_by_xpath('//*[@id="MainContent_cboVocativo"]/option[6]').click()
...
os.rename(nomeArquivo, 'EmpresasAereasEstrangeirasRegulares.csv')

#Transforma o Arquivo CSV em Excel
ce = csvexcel.transformaCSVExcel('EmpresasAereasEstrangeirasRegulares') 